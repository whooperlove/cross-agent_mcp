...
@server.tool(
    ...
    description=(
        ...
        'of the peer\'s transcript: the answer, which is the turn that echoed the delivery id '
        'back, or that the peer is still working. A later turn that does not echo it answers '
        'something else and is shown apart as unmatched_turn. Use it when a reply was '
        'recovered as a fragment, or a DELIVERY FAILED notice said the peer may still be working. '
